    ...
    try {
        ...
        querySnapshot.forEach((doc) => {
            ...
            const card = ` <div class="p-4 md:w-1/3">
                    <div class="h-full border-2 border-green-200 border-opacity-60 rounded-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center flex-wrap ">
                                <button onclick="buyNow(this)" class="text-green-500 inline-flex items-center md:mb-2 lg:mb-0">Add To Cart
